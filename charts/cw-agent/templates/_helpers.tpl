...
Common labels
*/}}
{{- define "cw-agent.labels" -}}
helm.sh/chart: {{ include "cw-agent.chart" . }}
{{ include "cw-agent.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "cw-agent.selectorLabels" -}}
app.kubernetes.io/name: {{ include "cw-agent.name" . }}
...
*/}}
{{- define "cw-agent.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "cw-agent.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "cw-agent.apiKeySecretKey" -}}
{{- if .Values.apiKey.existingSecret.name -}}
...
*/}}
{{- define "cw-agent.validateApiKey" -}}
